...
| **Tool integration** | Evaluators score every tool invocation (Foundry IQ, WebIQ, Azure SQL). |
...
- Tool routing for external research (WebIQ) and structured status lookup (Azure SQL) (t08, t09).
- Refusals: out-of-corpus template, signing, legal advice, injection, unauthorized-write bypass, non-standard clause (t10&ndash;t15).
