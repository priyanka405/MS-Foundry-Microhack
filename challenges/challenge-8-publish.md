...
For higher scale, host a separate Function App that reads from a Storage Queue and posts to the CLM API on a schedule &mdash; useful for the renewal reminder job.
