...
$challenges = @(
  ...
  [pscustomobject]@{ n=3; slug='tools-actions';        title='Tools &amp; Actions';                    lede='Wire up five tools: AI Search, File Search, Logic Apps (approval), Azure Functions (status &amp; risk), and Code Interpreter (reports).'; mins='75 min'; chip='Tools' }
